<?php
//https://github.com/mrXCray/PhoneCodes
//http://habrahabr.ru/blogs/php/102352
...
class PhoneConverter
{
    ...
    public static function convert($phone = '', $convert = true, $trim = true)
    {
        $phoneCodes = PhoneConverter::$phoneCodes; // только для примера! При реализации избавиться от глобальной переменной.
        ...
        foreach ($phoneCodes as $countryCode=>$data)
        {
            ...
            if (substr($phone, 0, $codeLen)==$countryCode)
            {
                ...
                return ($plus ? "+" : "").$countryCode.'('.$cityCode.')'.PhoneConverter::phoneBlocks($phone);
            }
        }
        // возвращаем результат без кода страны и города
        return ($plus ? "+" : "").PhoneConverter::phoneBlocks($phone);
    }    
}
